   	...
   	<script type="text/javascript">
   		$(document).ready(function() {
			$("#writeBtn").on("click", function() {
				if("${sessionScope.user_no}" == null || "${sessionScope.user_no}" == ""){
				...
				location.href="<c:url value='/board/board/write' />"
			})
		})
   	</script>
      ...
      <div class="qa-main">
        ...
        <div class="title-region">
          	<div class="title-mainline" style="display: flex; font-size: 20px;">
        	    ...
        	    <div style="position: absolute; left: 1040px;">조회수</div>
    	     </div>		
    	     <c:forEach var="articleDTO" items="${list}">
				<div class="title-line" style="display: flex; font-size: 20px;">
			        <div style="position: absolute; left: 100px;"><a href="<c:url value="/board/board/read${pr.sc.queryString}&article_no=${articleDTO.article_no}" />">${articleDTO.article_title}</a></div>
		           	...
		           	<div style="position: absolute; left: 1040px;" >${articleDTO.hit_count}</div>
		       	</div>					
			</c:forEach>
